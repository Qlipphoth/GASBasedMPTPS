...
class BLASTER_API UBlasterMovementComponent : public UCharacterMovementComponent
{
	...
	class FBlasterSavedMove : public FSavedMove_Character
	{
	public:
	...
	class FBlasterNetworkPredictionData_Client : public FNetworkPredictionData_Client_Character
	{
	public:
		typedef FNetworkPredictionData_Client_Character Super;

		FBlasterNetworkPredictionData_Client(const UCharacterMovementComponent& ClientMovement);
